...
*Follow priority 1â†?0 to decide which category to focus on first; use `--domain <Domain>` to query full details. The full rule text for every category lives in `references/quick-reference.md` â€?read it on demand rather than loading it every time.*
...
| 7 | Animation | MEDIUM | `ux`, `gsap` | Duration 150â€?00ms, Motion conveys meaning, Spatial continuity | Decorative-only animation, Animating width/height, No reduced-motion |
...
```bash
python ".tianxuan/skills/ui-ux-pro-max/scripts/search.py" "<query>" --domain <domain>
```
...
```bash
python ".tianxuan/skills/ui-ux-pro-max/scripts/search.py" "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
python ".tianxuan/skills/ui-ux-pro-max/scripts/search.py" "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python ".tianxuan/skills/ui-ux-pro-max/scripts/search.py" "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
python ".tianxuan/skills/ui-ux-pro-max/scripts/search.py" "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
python ".tianxuan/skills/ui-ux-pro-max/scripts/search.py" "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```

### Step 3: Supplement with Detailed Searches (as needed)

```bash
python ".tianxuan/skills/ui-ux-pro-max/scripts/search.py" "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python ".tianxuan/skills/ui-ux-pro-max/scripts/search.py" "<keyword>" --stack <stack>
```
...
python ".tianxuan/skills/ui-ux-pro-max/scripts/search.py" "AI search tool modern minimal" --design-system -p "AI Search"

# Step 3: supplement
python ".tianxuan/skills/ui-ux-pro-max/scripts/search.py" "search loading animation" --domain ux

# Step 4: stack guidelines
python ".tianxuan/skills/ui-ux-pro-max/scripts/search.py" "suspense streaming bundle" --stack nextjs
```
