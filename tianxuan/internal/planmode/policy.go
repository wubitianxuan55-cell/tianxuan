...
// Marker is the model-facing plan-mode instruction block. V10.135: the
// read_only_task/read_only_skill references were dropped (those tools do not
// exist and sub-agents are blocked in plan mode); the read-only investigation
// guidance now names actual tools.
