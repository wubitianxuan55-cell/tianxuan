...
func TestListPrecedenceProjectOverGlobal(t *testing.T) {
	home := t.TempDir()
	proj := t.TempDir()
	writeSkill(t, proj, ".tianxuan/skills/greet.md", "---\nname: greet\ndescription: project greet\n---\nproject body")
	writeSkill(t, home, ".tianxuan/skills/greet.md", "---\ndescription: global greet\n---\nglobal body")
	writeSkill(t, home, ".tianxuan/skills/onlyglobal.md", "---\ndescription: only global\n---\nbody")
...
func TestFlatAndDirLayout(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".tianxuan/skills/flat.md", "---\ndescription: flat\n---\nflat body")
	writeSkill(t, home, ".tianxuan/skills/dir/SKILL.md", "---\ndescription: dir\n---\ndir body")
...
func TestFrontmatterFields(t *testing.T) {
	...
	writeSkill(t, home, ".tianxuan/skills/fork.md", "---\ndescription: f\ncontext: fork\n---\nbody")
	writeSkill(t, home, ".tianxuan/skills/plain.md", "---\ndescription: p\n---\nbody")
...
func TestReferencesInlined(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".tianxuan/skills/withrefs/SKILL.md", "---\ndescription: r\n---\nmain body")
	writeSkill(t, home, ".tianxuan/skills/withrefs/references/b.md", "second ref")
	writeSkill(t, home, ".tianxuan/skills/withrefs/references/a.md", "first ref")
...
func TestBuiltinsPresentAndOverridable(t *testing.T) {
	...
	home := t.TempDir()
	writeSkill(t, home, ".tianxuan/skills/explore.md", "---\ndescription: mine\nrunAs: inline\n---\nbody")
...
func TestInvalidNamesSkipped(t *testing.T) {
	home := t.TempDir()
	writeSkill(t, home, ".tianxuan/skills/bad name.md", "---\ndescription: x\n---\nb") // space → invalid
	st := New(Options{HomeDir: home, DisableBuiltins: true})
	if len(st.List()) != 0 {
...
func TestSymlinkedDirAndFile(t *testing.T) {
	...
	skillsRoot := filepath.Join(home, ".tianxuan", "skills")
...
func TestCreateRefusesOverwrite(t *testing.T) {
	...
	if !strings.HasSuffix(path, filepath.Join(".tianxuan", "skills", "mine.md")) {
