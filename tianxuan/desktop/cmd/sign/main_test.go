...
func TestGenManifest(t *testing.T) {
	...
	t.Setenv("GITHUB_REPOSITORY", "wubitianxuan55-cell/tianxuan")
	...
	wantURL := "https://github.com/wubitianxuan55-cell/tianxuan/releases/download/desktop-v1.2.0/Tianxuan-windows-amd64-installer.exe"
	if win.URL != wantURL {
