...
export const zhTW: Record<DictKey, string> = {
  ...
  "workspace.reviewComments": "評論 ({n})",
  "workspace.reviewPrompt": "以下是評審評論，請逐條處理：",
  "workspace.sendReview": "傳送給 AI",
  "workspace.removeComment": "刪除評論",
  "worktrees.title": "工作樹",
  "worktrees.refresh": "重新整理",
  "worktrees.newPath": "新 worktree 路徑（絕對或相對）",
  "worktrees.newBranch": "新分支名稱",
  "worktrees.base": "基線（預設 HEAD）",
  "worktrees.create": "建立",
  "worktrees.created": "已建立",
  "worktrees.activate": "切換到此工作樹",
  "worktrees.remove": "刪除",
  "worktrees.removeConfirm": "刪除 worktree",
  "worktrees.current": "目前",
  "worktrees.detached": "detached",
  "worktrees.loading": "載入中…",
  "worktrees.empty": "目前儲存庫沒有 worktree",
  ...
  "settings.tab.hooks": "掛鉤",
  "settings.providerCount": "{n} 個提供者",
  "settings.agentMeta": "溫度 {temp} · 深度 {depth} · 步驟上限 {steps}",
  "settings.generalMeta": "一般",
  "settings.shortcutsMeta": "快速鍵",
  "settings.networkMeta": "代理",
  "settings.mcpMeta": "伺服器",
  "settings.skillsMeta": "專案",
  "settings.subagentsMeta": "設定",
  "settings.pluginsMeta": "擴充",
  "settings.memoryMeta": "記憶",
  "settings.hooksMeta": "事件",
  ...
  "memory.create": "建立",
  "memory.pending": "待確認",
  "memory.pendingCandidates": "待確認候選",
  "memory.noPending": "暫無待確認候選",
  "memory.pendingHint": "自動提取的記憶與 Dream 整合候選會先在此等待，確認後才寫入。",
  "memory.profileOverview": "專案畫像",
  "memory.profileTotal": "共 {n} 條記憶",
  "memory.profileConcepts": "核心概念",
  "memory.profileTypes": "類型分佈",
  "memory.profileErrors": "常見問題",
  "memory.globalBadge": "跨專案",
  "memory.recalledBadge": "召回 ×{n}",
  ...
  "browser.newTab": "新分頁",
  "browser.untitledTab": "新分頁",
  "browser.permissionTitle": "存取確認",
  "browser.permissionBody": "是否允許在應用程式內存取 {host}？確認後該網站將加入白名單。",
  "browser.allow": "允許",
  "browser.deny": "拒絕",
