...
> V8.15.0 — VS Code 健壮性补全 · 2026-06-21
## V8.15.0 发布摘要 (2026-06-21)
**基于**: V8.14.0 · **二进制**: CLI 20MB · **变更**: 2源文件 +130/-25行
🛡️ 设置项: 补全/CodeLens 开关 + sidecar 端口/二进制路径
💓 健康检查: 10s 心跳 + 3 次连续失败自动重启
🔌 端口管理: 冲突自动递增 (8080→8084)
⏳ 异步启动: 等待首次 /health 200 (最多 8s)
🛑 优雅关闭: SIGTERM → 3s → SIGKILL
📊 状态栏: healthy/starting/unhealthy/error 四种状态
🔒 缓存安全: 全部 L4 域 — Go 核心 L1/L2/L3 零变更
