// Package retrieval provides shared text-search primitives: CJK-aware
// tokenization, BM25 scoring, and snippet extraction. It is used by both the
// memory recall tool and the history search tool.
package retrieval
