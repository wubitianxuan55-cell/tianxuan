...
func TestGenManifest(t *testing.T) {
	...
	t.Setenv("GITHUB_REPOSITORY", "esengine/tianxuan")
	...
	wantURL := "https://github.com/esengine/tianxuan/releases/download/desktop-v1.2.0/Tianxuan-windows-amd64-installer.exe"
	if win.URL != wantURL {
