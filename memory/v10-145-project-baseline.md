---
name: v10-145-project-baseline
title: V10.145.0 项目基线
description: V10.145.0 项目基线 — 当前版本、构建命令、发布文件
---
...
| 发布位置 | `release/v10.145.0/tianxuan-desktop.exe` |
| 校验文件 | `release/v10.145.0/SHA256SUMS` |

### 发布文件清单

| 文件 | 用途 |
|------|------|
| `release/v10.145.0/tianxuan-desktop.exe` | 桌面端安装运行产物 |
| `release/v10.145.0/SHA256SUMS` | 产物校验值 |
