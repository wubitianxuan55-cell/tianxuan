...
export const zh: Record<DictKey, string> = {
  ...
  "workspace.reviewComments": "评论 ({n})",
  "workspace.reviewPrompt": "以下是评审评论，请逐条处理：",
  "workspace.sendReview": "发送给 AI",
  "workspace.removeComment": "删除评论",
  "worktrees.title": "工作树",
  "worktrees.refresh": "刷新",
  "worktrees.newPath": "新 worktree 路径（绝对或相对）",
  "worktrees.newBranch": "新分支名",
  "worktrees.base": "基线（默认 HEAD）",
  "worktrees.create": "创建",
  "worktrees.created": "已创建",
  "worktrees.activate": "切换到此工作树",
  "worktrees.remove": "删除",
  "worktrees.removeConfirm": "删除 worktree",
  "worktrees.current": "当前",
  "worktrees.detached": "detached",
  "worktrees.loading": "加载中…",
  "worktrees.empty": "当前仓库没有 worktree",
  ...
  // 计划确认卡片
  "plan.title": "计划确认",
  "plan.stepCount_one": "{n} 个步骤",
  "plan.stepCount_other": "{n} 个步骤",
  "plan.fileCount_one": "{n} 个文件",
  "plan.fileCount_other": "{n} 个文件",
  "plan.change": "变更描述：",
  "plan.dependsOn": "依赖步骤：",
  "plan.dependsNone": "无",
  "plan.success": "成功标准：",
  "plan.riskRecovery": "风险恢复：",
  ...
  "settings.agentMeta": "温度 {temp} · 深度 {depth} · 步数 {steps}",
  "settings.generalMeta": "通用",
  "settings.shortcutsMeta": "快捷键",
  "settings.networkMeta": "代理",
  "settings.mcpMeta": "服务",
  "settings.skillsMeta": "项目",
  "settings.subagentsMeta": "配置",
  "settings.pluginsMeta": "扩展",
  "settings.memoryMeta": "记忆",
  ...
  "memory.create": "创建",
  "memory.pending": "待确认",
  "memory.pendingCandidates": "待确认候选",
  "memory.noPending": "暂无待确认候选",
  "memory.pendingHint": "自动提取的记忆与 Dream 整合候选会先在此等待，确认后才落盘。",
  "memory.profileOverview": "项目画像",
  "memory.profileTotal": "共 {n} 条记忆",
  "memory.profileConcepts": "核心概念",
  "memory.profileTypes": "类型分布",
  "memory.profileErrors": "常见问题",
  "memory.globalBadge": "跨项目",
  ...
  "browser.newTab": "新标签页",
  "browser.untitledTab": "新标签页",
  "browser.permissionTitle": "访问确认",
  "browser.permissionBody": "是否允许在应用内访问 {host}？确认后该网站将被加入白名单。",
  "browser.allow": "允许",
  "browser.deny": "拒绝",
