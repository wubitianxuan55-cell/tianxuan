...
func TestRemoveProvider(t *testing.T) {
	...
	// Removing a non-default provider succeeds.
...
func TestPluginMutators(t *testing.T) {
	...
	if err := c.UpsertPlugin(PluginEntry{Name: "ex", Command: "tianxuan-plugin-example"}); err != nil {
...
func TestSaveToRoundTrips(t *testing.T) {
	...
	path := filepath.Join(t.TempDir(), "nested", "tianxuan.toml")
