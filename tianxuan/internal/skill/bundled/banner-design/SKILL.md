...
2. **Generate visual elements** with `ai-artist` + `ai-multimodal` skills
   ...
   **a) Search prompt inspiration** (6000+ examples in ai-artist):
   ```bash
   python3 .tianxuan/skills/ai-artist/scripts/search.py "<banner style keywords>"
   ```

   **b) Generate with Standard model** (fast, good for backgrounds/patterns):
   ```bash
   .tianxuan/skills/.venv/bin/python3 .tianxuan/skills/ai-multimodal/scripts/gemini_batch_process.py \
...
2. **Screenshot each banner** at exact platform dimensions:
   ...
   node .tianxuan/skills/chrome-devtools/scripts/screenshot.js \
...
- **Typography**: max 2 fonts, min 16px body, �?2px headline
