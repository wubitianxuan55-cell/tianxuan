...
// than shipped in the tianxuan binary, which keeps installs small. Resolve finds
...
// BundleDirName is the directory, beside the tianxuan executable, that the release
...
//  4. a bundle placed beside the tianxuan executable (fallback for manual setups).
//
...
// bundled looks for the CodeGraph launcher unpacked beside the tianxuan binary.
