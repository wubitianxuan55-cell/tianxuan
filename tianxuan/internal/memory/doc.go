...
const (
	ScopeUser     Scope = "user"     // ~/.config/tianxuan/TIANXUAN.md
	ScopeAncestor Scope = "ancestor" // a TIANXUAN.md above the project root
	ScopeProject  Scope = "project"  // ./TIANXUAN.md (committed, shared)
	ScopeLocal    Scope = "local"    // ./TIANXUAN.local.md (personal, git-ignored)
)

// docNames are the recognized memory filenames at each level, in load order.
// TIANXUAN.md is ours; AGENTS.md and CLAUDE.md are the cross-tool conventions.
