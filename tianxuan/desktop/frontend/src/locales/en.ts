...
export const en = {
  ...
  "workspace.reviewComments": "Comments ({n})",
  "workspace.reviewPrompt": "Review comments below, address each one:",
  "workspace.sendReview": "Send to AI",
  "workspace.removeComment": "Remove comment",
  "worktrees.title": "Worktrees",
  "worktrees.refresh": "Refresh",
  "worktrees.newPath": "New worktree path (absolute or relative)",
  "worktrees.newBranch": "New branch name",
  "worktrees.base": "Base (default HEAD)",
  "worktrees.create": "Create",
  "worktrees.created": "Created",
  "worktrees.activate": "Switch to this worktree",
  "worktrees.remove": "Remove",
  "worktrees.removeConfirm": "Remove worktree",
  ...
  "notify.taskDone": "Task complete",
  "notify.needApproval": "Approval needed",
  ...
  "settings.agentMeta": "temp {temp} · depth {depth} · steps {steps}",
  "settings.generalMeta": "general",
  "settings.shortcutsMeta": "shortcuts",
  "settings.networkMeta": "proxy",
  "settings.mcpMeta": "servers",
  "settings.skillsMeta": "project",
  "settings.subagentsMeta": "config",
  "settings.pluginsMeta": "extensions",
  "settings.memoryMeta": "memory",
  "settings.hooksMeta": "events",
  ...
  "memory.pendingCandidates": "Awaiting confirmation",
  "memory.noPending": "No pending candidates",
  "memory.pendingHint": "Auto-extracted facts and dream consolidations wait here until you confirm them.",
  "memory.profileOverview": "Project profile",
  "memory.profileTotal": "{n} memories",
  "memory.profileConcepts": "Core concepts",
  "memory.profileTypes": "Types",
  "memory.profileErrors": "Common issues",
  "memory.globalBadge": "Global",
  "memory.recalledBadge": "recalled ×{n}",
  ...
  "browser.untitledTab": "New tab",
  "browser.permissionTitle": "Permission required",
  "browser.permissionBody": "Allow {host} to open inside the app? It will be added to your allowlist.",
  "browser.allow": "Allow",
  "browser.deny": "Deny",
