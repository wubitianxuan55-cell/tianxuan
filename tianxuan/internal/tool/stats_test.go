...
func TestClassifyError(t *testing.T) {
	cases := []struct {
		...
		{"apply_patch", CodeExecError, "invalid patch: first line must be '*** Begin Patch'", "patch_parse_error"},
		{"apply_patch", CodeExecError, "chunk 1: 2 matches found, not unique", "block_not_unique"},
		{"apply_patch", CodeExecError, "chunk 1: lines not found (expected 3 line(s))", "block_not_found"},
